...
exports.crearGenerica = async function (oParam) { 
    ...
    try {
        ...
        oTabla.CodEmpresa       = oParam.oData.sCodEmpresa;
        oTabla.Empresa          = oParam.oData.sEmpresa;
        ...
        console.log(cacheProvider.isCache());
    } catch (e) { 
        oResponse.iCode     = -1;
...
/**
 * @description Función que permite eliminar tabla y sus parametros
